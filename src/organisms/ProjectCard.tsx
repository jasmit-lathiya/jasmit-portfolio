  ...
  return (
    ...
    >
      ...
      <AnimatePresence>
        {isModalOpen && (
          <motion.div
            className="fixed inset-0 z-50 flex items-end md:items-center justify-center bg-black/50 backdrop-blur-sm cursor-default"
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
            exit={{ opacity: 0 }}
          ...
          >
            {/* Modal content */}
            <motion.div
              className="bg-white dark:bg-gray-900 rounded-2xl p-6 max-w-lg w-full shadow-xl relative h-full md:h-auto max-h-[90vh] w-full md:w-auto"
            ...
            >
              ...
              {/* Explanation list */}
              <ul className="list-disc pl-5 space-y-2 text-gray-600 dark:text-gray-400 max-h-[70vh] overflow-y-auto no-scrollbar pt-4 pb-16 md:pb-4 border-t border-gray-300">
